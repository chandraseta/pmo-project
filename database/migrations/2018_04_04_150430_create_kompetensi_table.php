...
class CreateKompetensiTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('kompetensi', function (Blueprint $table) {
            ...
            $table->decimal('interaksional', 3, 2);
            ...
            $table->decimal('manajerial', 3, 2);

            $table->decimal('profil_potensi_keberhasilan', 3, 2);
            $table->decimal('profil_potensi_pengembangan_diri', 3, 2);
            $table->decimal('profil_loyalitas_terhadap_tugas', 3, 2);
            $table->decimal('profil_efektivitas_manajerial', 3, 2);
