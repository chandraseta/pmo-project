...
export default {
  ...
  methods: {
    changeTable: function(payload) {
      ...
      this.disableUploadDataButton =
        payload.name === "dataPegawai" || payload.name === "dataTraining";
    ...
    downloadTemplate: function() {
      ...
      switch (this.currentTab) {
        case "dataKompetensi":
          url = "/api/templates/kompetensi_template.xlsx";
          break;
        case "dataKinerja":
          url = "/api/templates/kinerja_template.xlsx";
          break;
      }
      window.open(url);
    },
    downloadData: function() {
      ...
      switch (this.currentTab) {
        case "dataPegawai":
          url = "/api/pegawai/export";
          break;
        case "dataKompetensi":
          url = "/api/kompetensi/export";
          break;
        case "dataKinerja":
          url = "/api/kinerja/export";
          break;
      }
      window.open(url);
    },
    uploadFile: function() {
      ...
      switch (this.currentTab) {
        case "dataKompetensi":
          url = "/api/kompetensi/import";
          break;
        case "dataKinerja":
          url = "/api/kinerja/import";
          break;
      }
